    ...
    public class MazePuzzleEditor : PuzzleBlendEditor<MazePuzzle>
    {
        public override void OnInspectorGUI()
        {
            ...
            serializedObject.Update();
            {
                ...
                if (EditorDrawing.BeginFoldoutBorderLayout(Properties["OnBallEnterWrongHole"], new GUIContent("Puzzle Events")))
                {
                ...
                if (EditorDrawing.BeginFoldoutBorderLayout(Properties["OnPuzzleInteractionStarted"], new GUIContent("Interaction Events")))
                {
